...
//      */
//     function updateEventListeners (el: Element, prevEvents: object, events: object) {
//       var eventName;
...
//      */
//     function addEventListeners (el: Element, eventName: string, handlers) {
//       var handler;
//       var i;
...
//      * @param {array|function} eventHandlers - Handler function or array of handler functions.
//      */
//     function removeEventListeners (el: Element, eventName: string, handlers) {
//       var handler;
//       var i;
...
declare module 'aframe-react';
  ...
  declare namespace JSX {
    interface IntrinsicElements {
      'a-assets': any;
      'a-camera': React.DetailedHTMLProps<React.HTMLAttributes<HTMLDivElement>, HTMLDivElement>;
      'a-entity': React.DetailedHTMLProps<React.HTMLAttributes<HTMLDivElement>, HTMLDivElement> & {
      primitive?: string;
      dimensions?: { width: number; height: number; depth: number };
      material?: { src: string };
      position?: { x: number; y: number; z: number };
      [look-at-camera]?: boolean;
    };
    }
  }
